...
public:
     ...
     * Frmát zpráv viz. GitHub Wiki - Referenční příručka Arduino
     *
   ...
   virtual void sendMessage(string line) = 0;
    ...
    /**
     * Metoda, která vrátí poslední zprávu datového zdroje nebo nic, pokud není nmová zpráva k dispozici.
     *
